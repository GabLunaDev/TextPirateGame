public class Menu {
    ...
    public static void MensagemInicial(String name) {
        System.out.println(Colors.ANSI_YELLOW + "\n ██████╗ █████╗  ██████╗ █████╗      █████╗  ██████╗     ████████╗███████╗███████╗ ██████╗ ██╗   ██╗██████╗  ██████╗ \n" +
                ...
                " ╚═════╝╚═╝  ╚═╝ ╚═██═╝╚═╝  ╚═╝     ╚═╝  ╚═╝ ╚═════╝        ╚═╝   ╚══════╝╚══════╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═╝ ╚═════╝ \n" +
                "                                                                                                                     " + Colors.ANSI_RESET);
        System.out.printf("O tesouro de " + Colors.ANSI_BOLD_TEXT + Colors.ANSI_CYAN + "Akassia" + Colors.ANSI_RESET + " e um dos mais antigos do mundo. Muitas pessoas tentaram encontrá-lo, porém, nenhuma das pessoas tiveram êxito nesse percurso. \n" +
                "Mares de ondas colossais, redemoinhos, entre outros empecilhos foram encontrados pelos caçadores de tesouros. Voce, " + Colors.ANSI_BOLD_TEXT + Colors.ANSI_RED + "%s" + Colors.ANSI_RESET + ", foi incentivado\n" +
